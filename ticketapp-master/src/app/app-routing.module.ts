...
const routes: Routes = [
  ...
  { path: 'admin-dashboard/:theatreid',component: AdminDashboardComponent,},
  { path: 'admin-dashboard/movie/:theatreid', component: MovieComponent },
  { path: 'admin-dashboard/add-movies/:theatreid',component: AddMoviesComponent,},
  { path: 'revenue/:theatreid', component: RevenueComponent,},
];
